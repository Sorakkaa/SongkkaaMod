	...
	protected void updateNarratedWidget(final NarrationElementOutput output) {
		...
		if (result != null) {
			...
			if (activeNarratables.size() > 1) {
				output.add(NarratedElementType.POSITION, Component.translatable("narrator.position.screen", new Object[]{result.index + 1, activeNarratables.size()}));
